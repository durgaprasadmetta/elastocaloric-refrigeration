...
with col1:
    ...
    # Fully native container boxes using official Streamlit components to prevent errors
    with st.container(border=True):
        st.markdown("### ❄️ Isolated Sub-Zero Vault")
        st.metric(label="Chamber Reading", value=f"{st.session_state.chamber_temp:.1f}°C", delta="Target: -18.0°C")
